// https://keestalkstech.com/2019/12/incorporate-free-ngrok-in-your-node-js-application-for-local-development/
...
const ngrokEnabled = process.env.NGROK === "true";
...
function startProcess() {
    ...
    const proc = spawn(ngrokBin, start, {
        cwd: ngrokDir,
        detached: true
    });
    proc.unref();
